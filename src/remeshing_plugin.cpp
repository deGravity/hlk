...
// Replaced by an in-tree EigenMeshToPolyhedron builder below — libigl's
// vendored CGAL bindings don't compile against modern CGAL.
...
void RemeshingMenu::draw_custom_window() {
    ...
    ImGui::SetNextWindowSize(ImVec2(300, std::max(300, window_height - 100)), ImGuiSetCond_FirstUseEver);
    ImGui::Begin(
        "Remeshing", nullptr,
...
/////////////////////////////////////////////////////////////////////////////
namespace {
    // In-tree replacement for igl::copyleft::cgal::mesh_to_polyhedron.
