...
int main(int argc, char* argv[]) {
    ...
    if (help) {
        std::cout <<
            ...
            "  -m, --input_model PATH  Preload this triangle mesh into the UI\n"
            "  -h, --help              Show this message\n";
        return help && positional.empty() ? 1 : 0;
    }
    ...
    if (!input_model.empty()) remeshing_menu.set_input_model(input_model);
    ...
    try {
        ...
        if (remeshing_menu.save_workspace()) std::cout << "Workspace saved.\n";
